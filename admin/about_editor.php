...
<body class="backdrop_parallax">
    ...
    <div class="page_old_full">
        ...
        <form method="POST" action=<?php echo ('updates/' . $file_update . '_update.php'); ?>>
            ...
            <div>
                <h3>Menu Category</h3>
                <p>Review or change the category this page belongs to.</p>
                <input type='radio' id='isMain' name='isMain' value='events_films' <?php echo $menuStatusOn; ?>>
                <label for='On Menu'>Events & Films</label><br />
                <input type='radio' id='isMain' name='isMain' value='visit' <?php echo $menuStatusOff; ?>>
                <label for='Off Menu'>Visit</label><br />
                <input type='radio' id='isMain' name='isMain' value='visit' <?php echo $menuStatusOff; ?>>
                <label for='Off Menu'>Support</label><br />
                <input type='radio' id='isMain' name='isMain' value='visit' <?php echo $menuStatusOff; ?>>
                <label for='Off Menu'>About</label>
            </div>
